...
export class KubernetesToolsPlugin extends BaseToolsPlugin<BaseTool> {
  ...
  protected createToolInstances(): BaseTool[] {
    return [
      ...
      new GetNodesTool(),
      new GetReplicaSetsTool(),
      new GetStatefulSetsTool(),
      new GetDaemonSetsTool(),
      new GetJobsTool(),
      new GetCronJobsTool(),
      new GetHPATool(),
      new GetPDBTool(),
      new GetEndpointsTool(),
      new GetEndpointSlicesTool(),
      new GetResourceQuotaTool(),
      new GetLimitRangesTool(),
      new PortForwardTool(),
      new GetResourceTool(),
